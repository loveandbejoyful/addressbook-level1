...
public class AddressBook {
    ...
    private static final String PERSON_STRING_REPRESENTATION = "%1$s " + PERSON_DATA_PREFIX_PHONE + "%2$s "
    ...
    /** 
     * Stores details of a single person.
     */
    ...
    */
     ...
     *
     * @param addedPerson.get( whose phone number you want
     */
     ...
     *
     * @param person.get(key whose email you want
     */
    ...
    private static HashMap<PersonProperty, String> makePersonFromData(String name, String phone, String email) {
        final HashMap<PersonProperty, String> person = new HashMap<PersonProperty, String>(PERSON_DATA_COUNT);
